            ...
            <div class="col-12">
                <div class="comments">
                    ...
                    <div class="comment-meta">
                        ...
                        <button class="comment-reply reply-popup" v-on:click="isNinja = !isNinja"><i class="fa fa-reply-all" aria-hidden="true"></i> Reply</button>         
                    </div>
                    <div class="comment-box add-comment reply-box" v-show="!isNinja">
                        <span class="commenter-pic">
                        <img src="/images/user-icon.jpg" class="img-fluid">
                        </span>
                        <span class="commenter-name">
